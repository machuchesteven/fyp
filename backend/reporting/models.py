...
class Report(models.Model):
    ...
    violation = models.ForeignKey(
        Violation, blank=True, null=True, on_delete=models.CASCADE
    )
    motorcycle = models.ForeignKey(Motorcycle, on_delete=models.CASCADE)

    # image = models.ImageField(upload_to='evidence_image', blank=True, null=True)
    def __str__(self):
...
class Detected(models.Model):
    ...
    inspected_url = models.TextField(null=True, blank=True)
